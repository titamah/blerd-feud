    ...
    <div className="fixed top-0 flex flex-col flex-1 items-center justify-center font-barlow h-full w-full dotted gap-10">
      ...
      <div className="flex flex-row gap-16">
        {[
          ...
          <div
            key={label}
            className={`flex flex-col items-center px-10 py-6 border-[6px] ${
              winning ? "border-black bg-black text-white" : "border-black bg-white text-black"
            }`}
          >
            <div className="font-barlow-condensed font-[700] text-3xl">{label}</div>
            <div className="font-space-mono font-[700] text-6xl mt-2">
